    ...
    <article className="w-full rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 md:p-6">
      ...
      <div className="grid grid-cols-2 py-3">
        <dl>
          ...
          <dd className="text-xl font-bold leading-none text-[#1A56DB] dark:text-[#16BDCA]">
            $23,635
          </dd>
        </dl>
        <dl>
          ...
          <dd className="text-xl font-bold leading-none text-[#0694A2] dark:text-[#0694A2]">
            -$18,230
          </dd>
        </dl>
      </div>
